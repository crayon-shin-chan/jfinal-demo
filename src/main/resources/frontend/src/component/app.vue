...
<template>
  <div>
    <el-menu default-active="/deployment"  mode="horizontal" :router="true" class="el-menu-demo" background-color="#545c64" text-color="#fff" active-text-color="#ffd04b">
      ...
      <el-menu-item index="/execution">执行</el-menu-item>
      <el-submenu index="/user">
        <template slot="title">用户</template>
        <el-menu-item index="/user">用户</el-menu-item>
        <el-menu-item index="/user/group">用户组</el-menu-item>
      </el-submenu>
      <el-submenu index="/history">
        <template slot="title">历史</template>
        <el-menu-item index="/history/process">流程</el-menu-item>
        <el-menu-item index="/history/task">任务</el-menu-item>
        <el-menu-item index="/history/variable">变量</el-menu-item>
        <el-menu-item index="/history/detail">详情</el-menu-item>
      </el-submenu>
      <el-submenu index="/management">
        <template slot="title">管理</template>
        <el-menu-item index="/management/database">数据库</el-menu-item>
        <el-menu-item index="/management/properties">属性</el-menu-item>
        <el-menu-item index="/management/jobs">任务</el-menu-item>
        <el-menu-item index="/management/timer-jobs">定时任务</el-menu-item>
        <el-menu-item index="/management/suspended-jobs">暂停任务</el-menu-item>
        <el-menu-item index="/management/deadletter-jobs">死信任务</el-menu-item>
        <el-menu-item index="/management/engine">引擎</el-menu-item> 
      </el-submenu>
    </el-menu>
